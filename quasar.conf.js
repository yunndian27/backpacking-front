...
module.exports = function (/* ctx */) {
  return {
    ...
    css: [
      ...
      'pageMyPage.scss',
      'pageSetting.scss',
      'pagePostArticle.scss',
      'pageArticle.scss',
      'pageMyArticleFile.scss',
      'pageTravelForum.scss',
      'pageDiscount.scss',
      'adminMain.scss',
      'adminArticles.scss'
    ],
    ...
    build: {
      ...
      env: {
        ...
        // API: ctx.dev
        //   ? 'https://dev.' + process.env.VUE_APP_API
        //   : 'https://prod.' + process.env.VUE_APP_API
      },
      // transpile: false,
